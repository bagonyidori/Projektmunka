    ...
    <div class="auth_box">
        ...
        <form class="auth_form" action="{{ route('register') }}" method="POST">
            ...
            <div class="form_group">
                ...
                <input type="text" id="name" name="name" class="form_input" placeholder="Pl. MovieBuff99" required autofocus>
            </div>
            ...
            <div class="form_group">
                ...
                <input type="password" id="password" name="password" class="form_input" placeholder="Minimum 8 karakter" required>
            </div>

            <div class="form_group">
                <label for="password_confirmation" class="form_label">Jelszó újra</label>
                <input type="password" id="password_confirmation" name="password_confirmation" class="form_input" placeholder="Jelszó megerősítése" required>
            </div>
